...
(function (root, factory) {
  ...
  function _showElement(targetElement) {
    ...
    if(oldHelperLayer != null) {
      ...
      /** HAX HAX HAX - Set a new helperLayer class if supplied (only works with steps) **/
      if (targetElement.numberLayerClass) {
        oldNumberLayerClass = targetElement.numberLayerClass;
        oldHelperNumberLayer.className = oldHelperNumberLayer.className + " " + oldNumberLayerClass;
      } else {
        oldHelperNumberLayer.className = "introjs-helperNumberLayer";
      }
      /** HAX HAX HAX **/
